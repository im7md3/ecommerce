...
<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item open "><a href="{{ route('admin.languages') }}"><i class="la la-home"></i>
            ...
            <li class="nav-item"><a href="{{route('admin.maincategories')}}"><i class="la la-group"></i>
                    ...
                    <span
                        class="badge badge badge-danger badge-pill float-right mr-2">{{ App\Models\MainCategories::where('translation_lang',get_default_lang())->count() }}</span>
                </a>
                <ul class="menu-content">
